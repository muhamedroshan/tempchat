...
const INPUT = ({countrycode,phno}) =>{
    ...
    <div >
            ...
            <select onChange={countrycode}>
                ...
                <option value='1907'>ALASKA (USA)</option>
                ...
                <option value='1284'>BRITISH VIRGINISLANDS</option>
                ...
                <option value="236">CENTRAL AFRICANREPUBLIC</option>	
                ...
                <option value="243">CONGO DEM. REP.(ZAIRE)</option>	
            ...
            <option value="1808">HAWAII (USA)</option>	
            ...
            <option value="996">KYRGHYZSTAN</option>	
            ...
            <option value="1670">MARIANA IS.(SAIPAN)</option>	
            <option value="692">MARSHALL ISLANDS</option>	
            <option value="596">MARTINIQUE(FRENCHANTILLES)</option>	
            ...
            <option value="1787">PUERTO RICO (I) (USA)</option>	
            <option value="1939">PUERTO RICO (II)(USA)</option>	
            <option value="974">QATAR</option>	
            ...
            <option value="1784">ST VINCENT ,GRENADINES</option>	 
            ...
            <option value="1649">TURKS , CAICOSISLANDS</option>	 
            ...
            <option value="1340">VIRGIN ISLAND (USA)</option>	
            <option value="681">WALLIS , FUTUNA</option>	
            <option value="967">YEMEN</option>	
            <option value="381">YUGOSLAVIA (SERBIA)</option>	
            <option value="260">ZAMBIA</option>	
            <option value="255">ZANZIBAR</option>	
            <option value="26">ZIMBABWE</option>	

            </select>
            <input type='number' id='phno' name='phno' placeholder='Phone number' onChange={phno}/><br/><br />
            </div>
